...
function wrong() {
  document
    ...
    .parentNode.removeChild(document.getElementById("input"));

  document
    .getElementById("button")
    .parentNode.removeChild(document.getElementById("button"));

  document
    .getElementById("block")
    .parentNode.removeChild(document.getElementById("block"));

  resetAll();

  document.getElementById("p").innerHTML =
    "Incorrect! <br><br> The correct answer was: " +
    randomNumber +
    "<br><br><b>Your Score: " +
    level +
    "</b>";
...
function continueTest() {
  document
    ...
    .parentNode.removeChild(document.getElementById("continueButton"));
