...
function start() {
    ...
    document.getElementById("content").innerHTML = "Text: <br><br><br>" + document.getElementById("text").innerHTML + "<br><br>";
...
function createTest() {
    ...
    const questionText = ["100 to 201 AD", "252 to 413 AD", "1376 to 1401 AD", "319 to 554 AD", "Russia", "Italy", "Sweden", "Britain", "1944", "1947", "1966", "1940", "True", "False", "Not explained in the text", "I don't know"];

    const questions = ["1) What time period did the Gupta Dynasty take place?", "2) Which European country took control of India?", "3) When was India granted independence from Britain?", "4) India and Pakistan have had strained relations"]
