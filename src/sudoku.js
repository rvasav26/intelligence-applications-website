var sudokuArray = [
  6, 2, 1, 7, 8, 9, 5, 3, 4, 3, 8, 5, 4, 6, 2, 1, 7, 9, 7, 9, 4, 5, 3, 1, 2, 6,
  8, 1, 5, 9, 6, 2, 7, 4, 8, 3, 4, 3, 8, 1, 9, 5, 7, 2, 6, 2, 7, 6, 8, 4, 3, 9,
  5, 1, 8, 4, 2, 9, 7, 6, 3, 1, 5, 5, 6, 3, 2, 1, 4, 8, 9, 7, 9, 1, 7, 3, 5, 8,
  6, 4, 2,
];
...
function checkNumber(num) {
  ...
  for (var x = 0; x < 81; x++) {
    if (
      document.getElementById("cell" + x).value ===
        document.getElementById("cell" + num).value &&
      document.getElementById("cell" + x).value != ""
    ) {
      document.getElementById("cell" + x).style.backgroundColor =
        "rgb(185, 218, 255)";
    }
  }
  if (document.getElementById("cell" + num).value == array[num]) {
    ...
    document.getElementById("cell" + num).style.backgroundColor =
      "rgb(185, 218, 255)";
  }
}
