var array = ["Select Month", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
...
function createQuiz() {
    ...
    document.getElementById("content").innerHTML += "Please enter the day of month you were born:<br>";
    document.getElementById("content").appendChild(zodiacInputDay);

    document.getElementById("content").innerHTML += "<br><br>Please select the month you were born:<br>";
...
function finishTest() {
    ...
    if (document.getElementById("zodiacInputDay").value < 10) {
        document.getElementById("zodiacInputDay").value = "0"+document.getElementById("zodiacInputDay").value

    }

    var zodiacNumber2 = "" + zodiacNumber + document.getElementById("zodiacInputDay").value;
    ...
    switch (true) {
        ...
        case (zodiacNumber2 >= 1122 && zodiacNumber2 <= 1221):
            ...
            break;
        case ((zodiacNumber2 >= 1222 && zodiacNumber2 <= 1231) || (zodiacNumber2 >= 11 && zodiacNumber2 <= 119)):
    ...
    zodiacImage.src = "https://www.astrology-zodiac-signs.com/images/" + zodiacSign + ".jpg"
    ...
    var zodiacHrefText = document.createTextNode("Learn more about your Zodiac Sign");
    zodiacHref.appendChild(zodiacHrefText)
    zodiacHref.setAttribute("href", "https://www.astrology-zodiac-signs.com/zodiac-signs/" + zodiacSign + "/")
