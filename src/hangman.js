...
var hangmanWordsCountryCapitals = [
  "paris",
  "london",
  "moscow",
  "new delhi",
...
function gameOver() {
  ...
  document.getElementById("wordContainer").innerHTML =
    "Game Over!<br>The correct answer was: " +
    randomWord +
    "<br>Time taken: " +
    endTime +
    " seconds<br><br>";
...
function youWin() {
  ...
  document.getElementById("wordContainer").innerHTML =
    "You Win!<br>Time taken: " + endTime + " seconds<br><br>";
  if (color2 === "green") {
...
function getHint() {
  ...
  if (
    randomWordArray[b] === " " ||
    document.getElementById(b).innerHTML === randomWordArray[b]
  ) {
    getHint();
  } else {
