...
function createQuestion() {
    ...
    document.getElementById("questionCount").innerHTML = "Question " + questionCount + " of 10"
    ...
    document.getElementById("question").innerHTML = "What is the Capital of " + question + "?"
...
function checkAnswer(choice) {
    ...
    if (document.getElementById("option" + choice).innerHTML === answer) {
        ...
        document.getElementById("correctIncorrect").innerHTML = "Incorrect! The Capital of "+question+ " is "+answer+"."
...
function endTest() {
    ...
    document.getElementById("endResultScore").innerHTML = "Your Score: " + correctCount;

    document.getElementById("endResultFinal").innerHTML = correctCount + " out of 10 answers correct."

    document.getElementById("endResultPercent").innerHTML = (correctCount / 10) * 100 + "%"
